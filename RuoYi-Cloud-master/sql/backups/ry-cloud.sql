...
INSERT INTO `gen_table` VALUES (18, 'news', '新闻表', NULL, NULL, 'News', 'crud', 'element-ui', 'com.ruoyi.meeting', 'meeting', 'news', '新闻管理', 'xiye', '0', '/', '{\"parentMenuId\":1}', 'admin', '2025-02-26 10:53:28', '', '2025-02-26 10:54:09', NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 199 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '代码生成业务表字段' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `gen_table_column` VALUES (190, 18, 'id', 'id', 'bigint', 'Long', 'id', '1', '1', NULL, '1', NULL, NULL, NULL, 'EQ', 'input', '', 1, 'admin', '2025-02-26 10:53:28', '', '2025-02-26 10:54:09');
INSERT INTO `gen_table_column` VALUES (191, 18, 'title', '新闻标题', 'varchar(255)', 'String', 'title', '0', '0', NULL, '1', '1', '1', '1', 'EQ', 'input', '', 2, 'admin', '2025-02-26 10:53:28', '', '2025-02-26 10:54:09');
INSERT INTO `gen_table_column` VALUES (192, 18, 'author', '作者', 'varchar(100)', 'String', 'author', '0', '0', NULL, '1', '1', '1', '1', 'EQ', 'input', '', 3, 'admin', '2025-02-26 10:53:28', '', '2025-02-26 10:54:09');
INSERT INTO `gen_table_column` VALUES (193, 18, 'url', '封面', 'varchar(255)', 'String', 'url', '0', '0', NULL, '1', '1', '1', '1', 'EQ', 'input', '', 4, 'admin', '2025-02-26 10:53:28', '', '2025-02-26 10:54:09');
INSERT INTO `gen_table_column` VALUES (194, 18, 'del_flag', '删除标志（0代表存在 2代表删除）', 'char(1)', 'String', 'delFlag', '0', '0', NULL, '1', NULL, NULL, NULL, 'EQ', 'input', '', 5, 'admin', '2025-02-26 10:53:28', '', '2025-02-26 10:54:09');
INSERT INTO `gen_table_column` VALUES (195, 18, 'create_by', '创建者', 'varchar(64)', 'String', 'createBy', '0', '0', NULL, '1', NULL, NULL, NULL, 'EQ', 'input', '', 6, 'admin', '2025-02-26 10:53:28', '', '2025-02-26 10:54:09');
INSERT INTO `gen_table_column` VALUES (196, 18, 'create_time', '创建时间', 'datetime', 'Date', 'createTime', '0', '0', NULL, '1', NULL, NULL, NULL, 'EQ', 'datetime', '', 7, 'admin', '2025-02-26 10:53:28', '', '2025-02-26 10:54:09');
INSERT INTO `gen_table_column` VALUES (197, 18, 'update_by', '更新者', 'varchar(64)', 'String', 'updateBy', '0', '0', NULL, '1', '1', NULL, NULL, 'EQ', 'input', '', 8, 'admin', '2025-02-26 10:53:28', '', '2025-02-26 10:54:09');
INSERT INTO `gen_table_column` VALUES (198, 18, 'update_time', '更新时间', 'datetime', 'Date', 'updateTime', '0', '0', NULL, '1', '1', NULL, NULL, 'EQ', 'datetime', '', 9, 'admin', '2025-02-26 10:53:28', '', '2025-02-26 10:54:09');
...
CREATE TABLE `image`  (
  `id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '图片编号',
  `url` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '图片链接',
  `type` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '图片类型',
  `extend` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '图片后缀（类型）',
  ...
  `remark` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '图片cos表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of image
-- ----------------------------
INSERT INTO `image` VALUES ('21366702', 'https://jn-1306384632.cos.ap-nanjing.myqcloud.com/article/21366702.png', 'SOCIAL_IMAGE', 'png', '0', '', '2025-02-26 15:19:15', '', NULL, NULL);
...
CREATE TABLE `meeting`  (
  ...
  `url` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '会议封面海报图',
  ...
  `remark` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 25 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '会议表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `meeting_activity`  (
  ...
  `title` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '活动标题',
  `time` datetime NOT NULL COMMENT '活动时间',
  `url` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '活动封面海报',
  ...
  `remark` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '会议活动表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `meeting_activity_sector`  (
  ...
  `title` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '板块标题',
  `url` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `description` varchar(2000) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '板块内容',
  `del_flag` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '0' COMMENT '删除标志（0代表存在 2代表删除）',
  `create_by` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '创建者',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '更新者',
  ...
  `remark` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '会议活动板块表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `meeting_agenda`  (
  ...
  `content` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '子议程内容',
  `meta` varchar(2000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '主讲人信息',
  `del_flag` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '0' COMMENT '删除标志（0代表存在 2代表删除）',
  `create_by` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '创建者',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '更新者',
  ...
  `remark` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '会议议程表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `meeting_chat`  (
  ...
  `content` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '聊天信息',
  `del_flag` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '0' COMMENT '删除标志（0代表存在 2代表删除）',
  `create_by` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '创建者',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '更新者',
  ...
  `remark` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '会议聊天表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `meeting_clip`  (
  ...
  `file_name` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '文件名称',
  `upload_user_id` bigint NULL DEFAULT NULL COMMENT '上传者',
  `file_type` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '文件类型',
  `file_size` int NULL DEFAULT 0 COMMENT '文件大小',
  `url` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT 'cos存储地址',
  `del_flag` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '0' COMMENT '删除标志（0代表存在 2代表删除）',
  `create_by` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '创建者',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '更新者',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 209 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '会议附件表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `meeting_geo`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT 'id',
  `country` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '国家',
  `formatted_address` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '格式化地址',
  ...
  `number` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '门牌',
  `adcode` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '区域编码',
  `location` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '经度，纬度',
  `del_flag` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '0' COMMENT '删除标志（0代表存在 2代表删除）',
  `create_by` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '创建者',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '更新者',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 208 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '会议地图表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `meeting_guest`  (
  ...
  `name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '嘉宾姓名',
  `title` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '嘉宾头衔',
  `content` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '嘉宾主讲内容',
  `views` int NULL DEFAULT 0 COMMENT '查看统计',
  `likes` int NULL DEFAULT 0 COMMENT '点赞统计',
  `avatar` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '嘉宾头像',
  `url` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '嘉宾海报',
  `del_flag` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '0' COMMENT '删除标志（0代表存在 2代表删除）',
  `create_by` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '创建者',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '更新者',
  ...
  `remark` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '会议嘉宾表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `meeting_schedule`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '会议预约表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `messages_logs`  (
  ...
  `role` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '用户角色：user,assistent',
  ...
  `remark` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 99 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'agent聊天记录表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `news`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT 'id',
  `title` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '新闻标题',
  `author` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '作者',
  `url` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '封面',
  `del_flag` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '0' COMMENT '删除标志（0代表存在 2代表删除）',
  `create_by` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '创建者',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '更新者',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 202 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '新闻表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of news
-- ----------------------------
INSERT INTO `news` VALUES (201, '测试~', 'admin', 'https://jn-1306384632.cos.ap-nanjing.myqcloud.com/article/21366702.png', '0', '', '2025-02-26 15:19:16', '', NULL);
...
CREATE TABLE `points`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT 'id',
  `title` varchar(150) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '积分任务名称',
  `description` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '疾风任务描述',
  ...
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 206 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '积分表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `points_exchange`  (
  ...
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 200 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户积分表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `points_items`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT 'id',
  `title` varchar(150) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '物品名称',
  `description` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '物品描述',
  ...
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 208 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '积分物品表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `points_record`  (
  ...
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 212 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '积分记录表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `points_wallet`  (
  ...
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 202 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户积分表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 112 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '定时任务调度表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `sys_logininfor` VALUES (214, 'admin', '127.0.0.1', '0', '登录成功', '2025-02-26 10:53:12');
...
INSERT INTO `sys_menu` VALUES (2063, '新闻管理查询', 2068, 1, '#', '', NULL, '', 1, 0, 'F', '0', '0', 'meeting:news:query', '#', 'admin', '2025-02-26 10:54:56', 'admin', '2025-02-26 14:38:00', '');
INSERT INTO `sys_menu` VALUES (2068, '新闻管理', 0, 3, 'news', 'meeting/news/index', NULL, '', 1, 1, 'C', '0', '0', NULL, 'education', 'admin', '2025-02-26 14:36:25', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2069, '新闻新增', 2068, 2, '', NULL, NULL, '', 1, 0, 'F', '0', '0', 'meeting:news:add', '#', 'admin', '2025-02-26 14:38:21', 'admin', '2025-02-26 14:38:27', '');
INSERT INTO `sys_menu` VALUES (2070, '新闻修改', 2068, 3, '', NULL, NULL, '', 1, 0, 'F', '0', '0', 'meeting:news:edit', '#', 'admin', '2025-02-26 14:38:48', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2071, '删除新闻', 2068, 4, '', NULL, NULL, '', 1, 0, 'F', '0', '0', 'meeting:news:remove', '#', 'admin', '2025-02-26 14:39:08', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2072, '新闻导出', 2068, 5, '', NULL, NULL, '', 1, 0, 'F', '0', '0', 'meeting:news:export', '#', 'admin', '2025-02-26 14:39:31', '', NULL, '');
...
) ENGINE = InnoDB AUTO_INCREMENT = 427 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '操作日志记录' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `sys_oper_log` VALUES (407, '代码生成', 6, 'com.ruoyi.gen.controller.GenController.importTableSave()', 'POST', 1, 'admin', NULL, '/gen/importTable', '127.0.0.1', '', '{\"tables\":\"news\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-02-26 10:53:29', 57);
INSERT INTO `sys_oper_log` VALUES (408, '代码生成', 2, 'com.ruoyi.gen.controller.GenController.editSave()', 'PUT', 1, 'admin', NULL, '/gen', '127.0.0.1', '', '{\"businessName\":\"news\",\"className\":\"News\",\"columns\":[{\"capJavaField\":\"Id\",\"columnComment\":\"id\",\"columnId\":190,\"columnName\":\"id\",\"columnType\":\"bigint\",\"createBy\":\"admin\",\"createTime\":\"2025-02-26 10:53:28\",\"dictType\":\"\",\"edit\":false,\"htmlType\":\"input\",\"increment\":true,\"insert\":true,\"isIncrement\":\"1\",\"isInsert\":\"1\",\"isPk\":\"1\",\"javaField\":\"id\",\"javaType\":\"Long\",\"list\":false,\"params\":{},\"pk\":true,\"query\":false,\"queryType\":\"EQ\",\"required\":false,\"sort\":1,\"superColumn\":false,\"tableId\":18,\"updateBy\":\"\",\"usableColumn\":false},{\"capJavaField\":\"Title\",\"columnComment\":\"新闻标题\",\"columnId\":191,\"columnName\":\"title\",\"columnType\":\"varchar(255)\",\"createBy\":\"admin\",\"createTime\":\"2025-02-26 10:53:28\",\"dictType\":\"\",\"edit\":true,\"htmlType\":\"input\",\"increment\":false,\"insert\":true,\"isEdit\":\"1\",\"isIncrement\":\"0\",\"isInsert\":\"1\",\"isList\":\"1\",\"isPk\":\"0\",\"isQuery\":\"1\",\"javaField\":\"title\",\"javaType\":\"String\",\"list\":true,\"params\":{},\"pk\":false,\"query\":true,\"queryType\":\"EQ\",\"required\":false,\"sort\":2,\"superColumn\":false,\"tableId\":18,\"updateBy\":\"\",\"usableColumn\":false},{\"capJavaField\":\"Author\",\"columnComment\":\"作者\",\"columnId\":192,\"columnName\":\"author\",\"columnType\":\"varchar(100)\",\"createBy\":\"admin\",\"createTime\":\"2025-02-26 10:53:28\",\"dictType\":\"\",\"edit\":true,\"htmlType\":\"input\",\"increment\":false,\"insert\":true,\"isEdit\":\"1\",\"isIncrement\":\"0\",\"isInsert\":\"1\",\"isList\":\"1\",\"isPk\":\"0\",\"isQuery\":\"1\",\"javaField\":\"author\",\"javaType\":\"String\",\"list\":true,\"params\":{},\"pk\":false,\"query\":true,\"queryType\":\"EQ\",\"required\":false,\"sort\":3,\"superColumn\":false,\"tableId\":18,\"updateBy\":\"\",\"usableColumn\":false},{\"capJavaField\":\"Url\",\"columnComment\":\"封面\",\"columnId\":193,\"columnName\":\"url\",\"columnType\":\"varchar(255)\",\"createBy\":\"admin\",\"createTime\":\"2025-02-26 10:53:28\",\"dictType\":\"\",\"edit\":true,\"htmlType\":\"input\",\"increment\":false,\"insert\":true,\"isEdit\":\"1\",\"isIncrement\":\"0\",\"isInsert\":\"1\",\"isList\":\"1\",\"isPk\":\"0\",\"isQuery\":\"1\",\"javaField\":\"url\",\"javaType\":\"String\",\"list\":true,\"params\":{},\"pk\":false,\"query\":true,\"queryType\":\"EQ\",\"re', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-02-26 10:54:09', 36);
INSERT INTO `sys_oper_log` VALUES (409, '代码生成', 8, 'com.ruoyi.gen.controller.GenController.batchGenCode()', 'GET', 1, 'admin', NULL, '/gen/batchGenCode', '127.0.0.1', '', '{\"tables\":\"news\"}', NULL, 0, NULL, '2025-02-26 10:54:13', 324);
INSERT INTO `sys_oper_log` VALUES (410, '菜单管理', 1, 'com.ruoyi.system.controller.SysMenuController.add()', 'POST', 1, 'admin', NULL, '/menu', '127.0.0.1', '', '{\"children\":[],\"component\":\"meeting/news/index\",\"createBy\":\"admin\",\"icon\":\"education\",\"isCache\":\"1\",\"isFrame\":\"1\",\"menuName\":\"新闻管理\",\"menuType\":\"C\",\"orderNum\":3,\"params\":{},\"parentId\":0,\"path\":\"news\",\"status\":\"0\",\"visible\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-02-26 14:36:25', 31);
INSERT INTO `sys_oper_log` VALUES (411, '菜单管理', 2, 'com.ruoyi.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', NULL, '/menu', '127.0.0.1', '', '{\"children\":[],\"component\":\"\",\"createTime\":\"2025-02-26 10:54:56\",\"icon\":\"#\",\"isCache\":\"0\",\"isFrame\":\"1\",\"menuId\":2063,\"menuName\":\"新闻管理查询\",\"menuType\":\"F\",\"orderNum\":1,\"params\":{},\"parentId\":2068,\"path\":\"#\",\"perms\":\"meeting:news:query\",\"routeName\":\"\",\"status\":\"0\",\"updateBy\":\"admin\",\"visible\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-02-26 14:37:12', 11);
INSERT INTO `sys_oper_log` VALUES (412, '菜单管理', 2, 'com.ruoyi.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', NULL, '/menu', '127.0.0.1', '', '{\"children\":[],\"component\":\"\",\"createTime\":\"2025-02-26 10:54:56\",\"icon\":\"#\",\"isCache\":\"0\",\"isFrame\":\"1\",\"menuId\":2064,\"menuName\":\"新闻管理新增\",\"menuType\":\"F\",\"orderNum\":2,\"params\":{},\"parentId\":2062,\"path\":\"#\",\"perms\":\"meeting:news:add\",\"routeName\":\"\",\"status\":\"0\",\"updateBy\":\"admin\",\"visible\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-02-26 14:37:17', 9);
INSERT INTO `sys_oper_log` VALUES (413, '菜单管理', 3, 'com.ruoyi.system.controller.SysMenuController.remove()', 'DELETE', 1, 'admin', NULL, '/menu/2064', '127.0.0.1', '', '2064', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-02-26 14:37:29', 10);
INSERT INTO `sys_oper_log` VALUES (414, '菜单管理', 3, 'com.ruoyi.system.controller.SysMenuController.remove()', 'DELETE', 1, 'admin', NULL, '/menu/2065', '127.0.0.1', '', '2065', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-02-26 14:37:31', 8);
INSERT INTO `sys_oper_log` VALUES (415, '菜单管理', 3, 'com.ruoyi.system.controller.SysMenuController.remove()', 'DELETE', 1, 'admin', NULL, '/menu/2066', '127.0.0.1', '', '2066', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-02-26 14:37:34', 6);
INSERT INTO `sys_oper_log` VALUES (416, '菜单管理', 3, 'com.ruoyi.system.controller.SysMenuController.remove()', 'DELETE', 1, 'admin', NULL, '/menu/2067', '127.0.0.1', '', '2067', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-02-26 14:37:40', 6);
INSERT INTO `sys_oper_log` VALUES (417, '菜单管理', 3, 'com.ruoyi.system.controller.SysMenuController.remove()', 'DELETE', 1, 'admin', NULL, '/menu/2062', '127.0.0.1', '', '2062', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-02-26 14:37:42', 6);
INSERT INTO `sys_oper_log` VALUES (418, '菜单管理', 2, 'com.ruoyi.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', NULL, '/menu', '127.0.0.1', '', '{\"children\":[],\"component\":\"\",\"createTime\":\"2025-02-26 10:54:56\",\"icon\":\"#\",\"isCache\":\"0\",\"isFrame\":\"1\",\"menuId\":2063,\"menuName\":\"新闻管理查询\",\"menuType\":\"F\",\"orderNum\":1,\"params\":{},\"parentId\":2068,\"path\":\"#\",\"perms\":\"meeting:news:query\",\"routeName\":\"\",\"status\":\"0\",\"updateBy\":\"admin\",\"visible\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-02-26 14:38:00', 7);
INSERT INTO `sys_oper_log` VALUES (419, '菜单管理', 1, 'com.ruoyi.system.controller.SysMenuController.add()', 'POST', 1, 'admin', NULL, '/menu', '127.0.0.1', '', '{\"children\":[],\"createBy\":\"admin\",\"isCache\":\"0\",\"isFrame\":\"1\",\"menuName\":\"新闻新增\",\"menuType\":\"F\",\"orderNum\":2,\"params\":{},\"parentId\":2068,\"perms\":\"meeting:news:query\",\"status\":\"0\",\"visible\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-02-26 14:38:21', 7);
INSERT INTO `sys_oper_log` VALUES (420, '菜单管理', 2, 'com.ruoyi.system.controller.SysMenuController.edit()', 'PUT', 1, 'admin', NULL, '/menu', '127.0.0.1', '', '{\"children\":[],\"createTime\":\"2025-02-26 14:38:21\",\"icon\":\"#\",\"isCache\":\"0\",\"isFrame\":\"1\",\"menuId\":2069,\"menuName\":\"新闻新增\",\"menuType\":\"F\",\"orderNum\":2,\"params\":{},\"parentId\":2068,\"path\":\"\",\"perms\":\"meeting:news:add\",\"routeName\":\"\",\"status\":\"0\",\"updateBy\":\"admin\",\"visible\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-02-26 14:38:27', 8);
INSERT INTO `sys_oper_log` VALUES (421, '菜单管理', 1, 'com.ruoyi.system.controller.SysMenuController.add()', 'POST', 1, 'admin', NULL, '/menu', '127.0.0.1', '', '{\"children\":[],\"createBy\":\"admin\",\"isCache\":\"0\",\"isFrame\":\"1\",\"menuName\":\"新闻修改\",\"menuType\":\"F\",\"orderNum\":3,\"params\":{},\"parentId\":2068,\"perms\":\"meeting:news:edit\",\"status\":\"0\",\"visible\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-02-26 14:38:48', 10);
INSERT INTO `sys_oper_log` VALUES (422, '菜单管理', 1, 'com.ruoyi.system.controller.SysMenuController.add()', 'POST', 1, 'admin', NULL, '/menu', '127.0.0.1', '', '{\"children\":[],\"createBy\":\"admin\",\"isCache\":\"0\",\"isFrame\":\"1\",\"menuName\":\"删除新闻\",\"menuType\":\"F\",\"orderNum\":4,\"params\":{},\"parentId\":2068,\"perms\":\"meeting:news:remove\",\"status\":\"0\",\"visible\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-02-26 14:39:08', 6);
INSERT INTO `sys_oper_log` VALUES (423, '菜单管理', 1, 'com.ruoyi.system.controller.SysMenuController.add()', 'POST', 1, 'admin', NULL, '/menu', '127.0.0.1', '', '{\"children\":[],\"createBy\":\"admin\",\"isCache\":\"0\",\"isFrame\":\"1\",\"menuName\":\"新闻导出\",\"menuType\":\"F\",\"orderNum\":5,\"params\":{},\"parentId\":2068,\"perms\":\"meeting:news:export\",\"status\":\"0\",\"visible\":\"0\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-02-26 14:39:31', 5);
INSERT INTO `sys_oper_log` VALUES (424, '新闻管理', 1, 'com.ruoyi.meeting.controller.NewsController.add()', 'POST', 1, 'admin', NULL, '/news', '127.0.0.1', '', '{\"author\":\"2\",\"createTime\":\"2025-02-26 14:39:48\",\"id\":200,\"params\":{},\"title\":\"1\",\"url\":\"3\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-02-26 14:39:48', 90);
INSERT INTO `sys_oper_log` VALUES (425, '新闻管理', 3, 'com.ruoyi.meeting.controller.NewsController.remove()', 'DELETE', 1, 'admin', NULL, '/news/200', '127.0.0.1', '', '[200]', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-02-26 14:39:57', 10);
INSERT INTO `sys_oper_log` VALUES (426, '新闻管理', 1, 'com.ruoyi.meeting.controller.NewsController.add()', 'POST', 1, 'admin', NULL, '/news/add', '127.0.0.1', '', '{\"author\":\"admin\",\"createTime\":\"2025-02-26 15:19:15\",\"id\":201,\"params\":{},\"title\":\"测试~\",\"url\":\"https://jn-1306384632.cos.ap-nanjing.myqcloud.com/social/21366702.png\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2025-02-26 15:19:15', 35);
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 103, 'admin', 'xiye', '00', 'ry@163.com', '15888888888', '1', 'https://jn-1306384632.cos.ap-nanjing.myqcloud.com/avatar/avatar1.jpg', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', '2025-02-26 10:53:12', 'admin', '2024-12-15 14:16:55', '', '2025-02-26 10:53:12', '管理员');
